...
// https://www.reinfolib.mlit.go.jp/help/apiManual/#titleApi11
 ...
 * XKT003
 *
 * 都市計画決定GISデータ（立地適正化計画）APIリクエストパラメータ
 */
export type XKT003RequestParameters = {
  /**
   * 応答形式
   *
 ...
 * XKT003
 *
 * 都市計画決定GISデータ（立地適正化計画）APIレスポンスGeoJSON形式
 */
export type XKT003ResponseDataGeoJson = {
  type: "Feature";
  geometry: {
    type: "Polygon";
 ...
 * XKT003
 *
 * 都市計画決定GISデータ（立地適正化計画）APIレスポンスバイナリベクトルタイル形式
 */
export type XKT003ResponseDataPbf = ArrayBuffer;
